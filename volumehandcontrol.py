...
while True:
    ...
    if len(lmList) != 0:
        ...
        vol = np.interp(length, [46, 280], [minVol, maxVol])
        volBar = np.interp(length, [46, 280], [400, 150])
        volPer = np.interp(length, [46, 280], [0, 100])
    ...
    '''cv2.rectangle(img, (46, 150), (85, 400), (0, 255, 0), 3)
    cv2.rectangle(img, (46, int(volBar)), (85, 400), (0, 255, 0), cv2.FILLED)
